...
if ('filtered_df_test' in st.session_state) :
    ...
    st.dataframe(df_test.replace('',0).style.background_gradient(cmap='Reds',axis=1, subset=df_test.columns[2:-1]).replace(0,''), use_container_width=True, hide_index=True)
